...
min_0 = ps_df[ps_df['Min_Price']==0.0]
max_0 = ps_df[ps_df['Max_Price']==0.0]
modal_0 = ps_df[ps_df['Modal_Price']==0.0]
min_max_0 = ps_df[(ps_df['Min_Price']==0.0) & (ps_df['Max_Price']==0.0)]
min_modal_0 = ps_df[(ps_df['Min_Price']==0.0) & (ps_df['Modal_Price']==0.0)]
max_modal_0 = ps_df[(ps_df['Max_Price']==0.0) & (ps_df['Modal_Price']==0.0)]
min_max_modal_0 = ps_df[(ps_df['Max_Price']==0.0) & (ps_df['Modal_Price']==0.0) & (ps_df['Min_Price']==0.0)]

print(f'rows with min price as 0:\n{min_0}')
print(f'rows with max price as 0:\n{max_0}')
print(f'rows with modal price as 0:\n{modal_0}')
...
# (114, 10) are with 0 min;
# (611, 10) are with 0 max;
# (3, 10) are with 0 modal;
